...
demuxers, and filters remain enabled, including H.264, HEVC, and VC-1.
...
emulation, and performs an H.264-to-JPEG smoke test.

After those checks pass for `main`, CI publishes
`luci-videoplayer-codec-runtime-6.1.4-r1.apk`, its checksum, build metadata,
